# ut-docker-cli-pull-linux
The here described Universal Task calls the docker  "pull" image command, which helps to pull a image or a repository form a registry.
# Abstract: 
...
Universal Task name: ut-docker-cli-pull-linux
